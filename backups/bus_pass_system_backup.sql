...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ '8c97d129-631d-11f1-9434-0a0027000002:1-6';
...
CREATE TABLE `bus_pass` (
  ...
  `destination_stop` varchar(255) DEFAULT NULL,
  `enrollment_no` varchar(255) DEFAULT NULL,
  `mobile_number` varchar(255) DEFAULT NULL,
  `route_name` varchar(255) DEFAULT NULL,
  `source_stop` varchar(255) DEFAULT NULL,
...
--
-- Dumping routines for database 'bus_pass_system'
--
...
-- Dump completed on 2026-06-08 17:32:50
